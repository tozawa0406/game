...
PaidWaitAction::PaidWaitAction(void)
{
}
...
void PaidWaitAction::Init(PlayerHunter* player, Controller* ctrl)
{
	if (!player) { return; }
...
void PaidWaitAction::Uninit(void)
{
}

PlayerAction* PaidWaitAction::Update(void)
{

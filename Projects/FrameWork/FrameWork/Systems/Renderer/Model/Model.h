...
private:
	...
	const ANIMATION_INFO animationGameFileName[(int)Animation::Game::MAX]
	{
		...
		{ directoryName + "unitychan_animation/unitychan_dive.bamx"					, (int)Game::UNITY_CHAN },
		{ directoryName + "unitychan_animation/unitychan_KnockBack.bamx"			, (int)Game::UNITY_CHAN },
		{ directoryName + "unitychan_animation/unitychan_KnockOut.bamx"				, (int)Game::UNITY_CHAN },
		...
		{ directoryName + "unitychan_animation/unitychan_walksetup.bamx"			, (int)Game::UNITY_CHAN },

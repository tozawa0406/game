...
HRESULT DirectX11::InitAll(void)
{
	...
	{
		wrapper_->Init();
		wrapper_->GetFont()->CreateStringData("A阿あ", 100);
	}
...
{
	wrapper_->GetFont()->Draw("あA阿あAA", VECTOR2((float)Half(Windows::WIDTH), (float)Half(Windows::HEIGHT)), VECTOR2(100, 100), COLOR(0, 0, 0, 1), true, VECTOR2(200, 300));
